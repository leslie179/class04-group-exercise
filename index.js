...
/**
 * initialise the variable `student one` to the value of 18
 * increment the variable z by 5
 * console log out the variable `student one`. Write a single line comment as to what that output will be
 */
var stuedntOne = 18;
stuedntOne+= 5;
console.log(stuedntOne); // 23


// Question 13 - write your own averaging question + answer
/**initialise "box" as the variable and 40 as the value.
 * initialise "pencil" as the vaiable and 20 as the value.
 * initialise average to the average of box and pencil.
 * Find out the total with console log. Write the answer with a single line comment.
 */ 
var box = 40;
var pencil = 20;
var average = (box + pencil)/2
...
/**
 * initialise the variable `christmas gift` to the value of 3
 * initialise the variable `birthday gift` to the value of 1
 * initialise the variable `new year gift` to the value of 2
 * initialise total to the average of christmas gift, birthday gift and new year gift
 * console log the total and round the total to 1 decimal places. Write a single line comment as to what will be displayed
 */
var christmasGift = 3;
var birthdayGift = 1;
var newYearGift = 2;
var total = (christmasGift + birthdayGift + newYearGift)/3;
console.log(total.toFixed(1)); // 2.0
